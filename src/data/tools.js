...
export const TOOLS = [
  // ── TPE (10 tools) ──
  { id:"tpe-1",  name:"TPE Tool 1",  v:"2.3.0", cat:"HW", dev_site:"TPE", dev_unit:"Monitor", unit:"HW Q",
    dev:{name:"王建民",email:"jm.wang@company.com",ext:"2501"}, hasReport:true, uses:6 },
  { id:"tpe-2",  name:"TPE Tool 2",  v:"1.2.0", cat:"HW", dev_site:"TPE", dev_unit:"Monitor", unit:"HW Q",
    dev:{name:"王建民",email:"jm.wang@company.com",ext:"2501"}, hasReport:false, uses:3 },
  { id:"tpe-3",  name:"TPE Tool 3",  v:"1.0.0", cat:"HW", dev_site:"TPE", dev_unit:"Monitor", unit:"HW Q",
    dev:{name:"王建民",email:"jm.wang@company.com",ext:"2501"}, hasReport:true, uses:0 },
  { id:"tpe-4",  name:"TPE Tool 4",  v:"3.1.0", cat:"SW", dev_site:"TPE", dev_unit:"Monitor", unit:"SW Q",
    dev:{name:"林雅婷",email:"yt.lin@company.com",ext:"2502"}, hasReport:true, uses:5 },
  { id:"tpe-5",  name:"TPE Tool 5",  v:"1.0.5", cat:"SW", dev_site:"TPE", dev_unit:"Monitor", unit:"SW Q",
    dev:{name:"林雅婷",email:"yt.lin@company.com",ext:"2502"}, hasReport:false, uses:3 },
  { id:"tpe-6",  name:"TPE Tool 6",  v:"2.0.1", cat:"HW", dev_site:"TPE", dev_unit:"TV", unit:"HW Q",
    dev:{name:"張志偉",email:"cw.chang@company.com",ext:"2601"}, hasReport:true, uses:4 },
  { id:"tpe-7",  name:"TPE Tool 7",  v:"1.5.0", cat:"HW", dev_site:"TPE", dev_unit:"TV", unit:"HW Q",
    dev:{name:"張志偉",email:"cw.chang@company.com",ext:"2601"}, hasReport:true, uses:3 },
  { id:"tpe-8",  name:"TPE Tool 8",  v:"2.2.0", cat:"SW", dev_site:"TPE", dev_unit:"TV", unit:"SW Q",
    dev:{name:"陳怡君",email:"yc.chen@company.com",ext:"2602"}, hasReport:true, uses:5 },
  { id:"tpe-9",  name:"TPE Tool 9",  v:"1.3.0", cat:"SW", dev_site:"TPE", dev_unit:"TV", unit:"SW Q",
    dev:{name:"陳怡君",email:"yc.chen@company.com",ext:"2602"}, hasReport:true, uses:3 },
  { id:"tpe-10", name:"TPE Tool 10", v:"1.0.0", cat:"SW", dev_site:"TPE", dev_unit:"TV", unit:"SW Q",
    dev:{name:"陳怡君",email:"yc.chen@company.com",ext:"2602"}, hasReport:false, uses:2 },
  // ── XM (10 tools) ──
  { id:"xm-1",  name:"XM Tool 1",  v:"1.8.0", cat:"HW", dev_site:"XM", dev_unit:"TV", unit:"HW Q",
    dev:{name:"李明華",email:"mh.li@company.com",ext:"3501"}, hasReport:true, uses:4 },
  { id:"xm-2",  name:"XM Tool 2",  v:"2.0.0", cat:"SW", dev_site:"XM", dev_unit:"TV", unit:"SW Q",
    dev:{name:"黃雅琪",email:"yc.huang@company.com",ext:"3502"}, hasReport:true, uses:3 },
  { id:"xm-3",  name:"XM Tool 3",  v:"0.9.0", cat:"SW", dev_site:"XM", dev_unit:"TV", unit:"SW Q",
    dev:{name:"黃雅琪",email:"yc.huang@company.com",ext:"3502"}, hasReport:true, uses:0 },
  { id:"xm-4",  name:"XM Tool 4",  v:"1.1.0", cat:"SW", dev_site:"XM", dev_unit:"TV", unit:"SW Q",
    dev:{name:"黃雅琪",email:"yc.huang@company.com",ext:"3502"}, hasReport:true, uses:3 },
  { id:"xm-5",  name:"XM Tool 5",  v:"1.4.0", cat:"HW", dev_site:"XM", dev_unit:"TV", unit:"HW Q",
    dev:{name:"李明華",email:"mh.li@company.com",ext:"3501"}, hasReport:true, uses:2 },
  { id:"xm-6",  name:"XM Tool 6",  v:"2.1.0", cat:"HW", dev_site:"XM", dev_unit:"TV", unit:"HW Q",
    dev:{name:"李明華",email:"mh.li@company.com",ext:"3501"}, hasReport:false, uses:4 },
  { id:"xm-7",  name:"XM Tool 7",  v:"1.6.0", cat:"SW", dev_site:"XM", dev_unit:"TV", unit:"SW Q",
    dev:{name:"黃雅琪",email:"yc.huang@company.com",ext:"3502"}, hasReport:true, uses:3 },
  { id:"xm-8",  name:"XM Tool 8",  v:"1.0.1", cat:"SW", dev_site:"XM", dev_unit:"TV", unit:"SW Q",
    dev:{name:"黃雅琪",email:"yc.huang@company.com",ext:"3502"}, hasReport:false, uses:1 },
  { id:"xm-9",  name:"XM Tool 9",  v:"2.3.0", cat:"HW", dev_site:"XM", dev_unit:"TV", unit:"HW Q",
  ...
  { id:"fq-2",  name:"FQ Tool 2",  v:"1.0.0", cat:"HW", dev_site:"FQ", dev_unit:"Monitor", unit:"HW Q",
    dev:{name:"吳俊傑",email:"cj.wu@company.com",ext:"4501"}, hasReport:true, uses:2 },
  { id:"fq-3",  name:"FQ Tool 3",  v:"1.0.2", cat:"SW", dev_site:"FQ", dev_unit:"Monitor", unit:"SW Q",
    dev:{name:"趙美玲",email:"ml.zhao@company.com",ext:"4502"}, hasReport:false, uses:1 },
  { id:"fq-4",  name:"FQ Tool 4",  v:"1.3.0", cat:"HW", dev_site:"FQ", dev_unit:"Monitor", unit:"HW Q",
    dev:{name:"吳俊傑",email:"cj.wu@company.com",ext:"4501"}, hasReport:true, uses:4 },
  { id:"fq-5",  name:"FQ Tool 5",  v:"2.0.0", cat:"SW", dev_site:"FQ", dev_unit:"Monitor", unit:"SW Q",
    dev:{name:"趙美玲",email:"ml.zhao@company.com",ext:"4502"}, hasReport:true, uses:2 },
  { id:"fq-6",  name:"FQ Tool 6",  v:"1.5.0", cat:"HW", dev_site:"FQ", dev_unit:"Monitor", unit:"HW Q",
    dev:{name:"吳俊傑",email:"cj.wu@company.com",ext:"4501"}, hasReport:false, uses:3 },
  { id:"fq-7",  name:"FQ Tool 7",  v:"1.1.0", cat:"SW", dev_site:"FQ", dev_unit:"Monitor", unit:"SW Q",
    dev:{name:"趙美玲",email:"ml.zhao@company.com",ext:"4502"}, hasReport:true, uses:1 },
  { id:"fq-8",  name:"FQ Tool 8",  v:"2.2.0", cat:"HW", dev_site:"FQ", dev_unit:"Monitor", unit:"HW Q",
    dev:{name:"吳俊傑",email:"cj.wu@company.com",ext:"4501"}, hasReport:true, uses:5 },
  { id:"fq-9",  name:"FQ Tool 9",  v:"0.8.0", cat:"SW", dev_site:"FQ", dev_unit:"Monitor", unit:"SW Q",
    dev:{name:"趙美玲",email:"ml.zhao@company.com",ext:"4502"}, hasReport:true, uses:0 },
  { id:"fq-10", name:"FQ Tool 10", v:"1.4.0", cat:"SW", dev_site:"FQ", dev_unit:"Monitor", unit:"SW Q",
